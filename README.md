...
A modern, role‑aware document ingestion system with authentication for AI training pipelines. Built with Next.js App Router, Supabase, Clerk, Tailwind, and shadcn/ui. It supports secure uploads, automated labeling, duplicate detection, an admin review workflow, and a comprehensive data quality dashboard (admin‑only).
