...
import { Upload, Files, BarChart3, Shield, Settings, Database } from "lucide-react"
          ...
          <TabsContent value="upload" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                ...
                <CardContent>
                  <div className="border-2 border-dashed border-slate-600 rounded-lg p-8 text-center bg-gradient-to-br from-slate-800/30 to-slate-700/30 hover:from-slate-700/40 hover:to-slate-600/40 transition-all duration-300">
                    <Upload className="h-12 w-12 text-slate-400 mx-auto mb-4" />
                    <p className="text-lg font-medium text-slate-300 mb-2">Click to upload or drag and drop</p>
                    <p className="text-sm text-slate-500">Supports CSV, Excel, JSON, XML, and Text files up to 100MB</p>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-red-600/20 to-red-500/10 p-4 rounded-lg border border-red-500/20">
          ...
          <TabsContent value="settings">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">Configure your data ingestion preferences</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  {isAdmin && (
                    <div className="border-t border-slate-700 pt-4">
                      <h3 className="text-white font-medium mb-2">Admin Settings</h3>
                      <div className="space-y-2">
                        <Button
                          variant="outline"
                          size="sm"
                          className="border-slate-600 text-slate-300 mr-2 bg-transparent"
                        >
                          User Management
                        </Button>
                        <Button variant="outline" size="sm" className="border-slate-600 text-slate-300 bg-transparent">
